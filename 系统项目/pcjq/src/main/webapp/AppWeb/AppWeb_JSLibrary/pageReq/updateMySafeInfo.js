...
function subRiskLevel(){debugger;
	var evalAnswer = 0;/* 临时变量*/
 ...
 * 居住地国家发生变化时事件
 */
function changeResideNation(){debugger;
	var reside_nation = $("#reside_nation").val();
	var defOption = '<option value="">请选择</option>';
	if(reside_nation == "1"){
...
$(function(){
	var taxResident=getUrlParameter("taxResident");
	if(taxResident=="true"){
		showRevenueResidentDiv()
	}
})