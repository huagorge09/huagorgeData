...
<div class="clearfix form-multi-col-panel">
  ...
  <div class="form-item-group form-horizontal" role="form">
        <div class="form-item">
            <span class="form-field">第三方支付渠道：</span>
            <span class="form-input">
             	<select name="bnkNo"  class="form-control use-select2" placeholder="银行代码"  id='selBankNm'>
            </select>
            </span>
        </div>
...
<div class="jqGrid_wrapper fullscreen-wrapper">
    <table id="payChannelList"></table>
    <div id="payChannelPage"></div>
</div>
</body>
<script type="text/javascript" src="<%=context%>web/js/common/widget.js?20180603"></script>
<script type="text/javascript" src="<%=context%>web/js/bankMgr/payChannelList.init.js?20180601"></script>
