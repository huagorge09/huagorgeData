...
<div class="page-content">
    ...
    <div class="page-body">
    	...
    	<input type="hidden" name="oldPmco" id="oldPmco" value="${oldPmco}">
          <div class="form-group">
               <label class="col-sm-2 control-label">参数值<span class="text-danger">*</span></label>
                <div class="col-sm-4 form-inner">
                  <input type="text" placeholder="参数值：" class="form-control" name="pmco" id="pmco" value="${pmco}" />
               </div>
                <label class="col-sm-2 control-label">参数名<span class="text-danger">*</span></label>
                <div class="col-sm-4 form-inner">
                  <input type="text" placeholder="参数名：" class="form-control" name="pmnm" id="pmnm" value="${pmnm}"/>
               </div>
          </div>
...
<script type="text/javascript" src="<%=context%>web/js/param/parameter.update.js"></script>
