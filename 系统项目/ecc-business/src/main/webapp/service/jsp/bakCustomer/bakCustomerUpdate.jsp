...
<body class="fixed-nav gray-bg">
	<div class="modal-content" style="border: 0px;box-shadow: 0 0px 0px;">
		...
		<div class="page-header" style="margin: 0;">
			<h4 class="page-title">备案客户信息修改</h4>
					...
					<tbody id="idinfo">
						<tr>
							...
							<td class="white-bg">
								<div class="col-sm-11 form-inner">
									<input type='text' class='form-control' name='orgInvNm' id='orgInvNm' style="float: left;" value="${dto.invnm }"/>
								</div>
							</td>
						...
						<tr>
							...
							<td class="white-bg" colspan="3">
								<div class="col-sm-11 form-inner">
									<input type='text' class='form-control' name='orgInstrepnm' id='orgInstrepnm' onKeyUp="changeInstrep(this,'orgPrincipalname',false)" value="${dto.instrepnm }"/>
								</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="white-bg">
								<div class="col-sm-11 form-inner">
									<input type='text' style="float: left;" class='form-control' name='orgInstrepidvalidate' id='orgInstrepidvalidate' onchange="changeInstrep(this,'orgPrincipalidvalidate',false)" value="${dto.instrepvalidate }"/>
									<label style="line-height: 34px;margin: 0;">
								...
								<div style="display: none;" class="orgContactrightDiv">
									<div class="col-sm-11 form-inner">
										<select name="orgContactright" id="oocontactgrant" class='form-control orgContactright'>
											<c:forEach var="item" items="${contprivArray}">
											<option value="${item.PMCO}" ${item.PMCO == '0' ? "selected" : "" }>${item.PMCO}&nbsp;&nbsp;${ item.PMNM }</option>
											</c:forEach>
										</select>
									</div>
								</div>
								...
								<div class="col-sm-11 form-inner">
									<select name="bakCustRole" id="bakCustRole" class='form-control select2_width'>
										<c:forEach var="item" items="${custRoleArray}">
											<option value="${item.PMCO}" ${item.PMCO == dto.rcdcustrole ? "selected" : "" }>${item.PMCO}&nbsp;&nbsp;${ item.PMNM }</option>
										</c:forEach>
									</select>
								</div>
							</td>
								...
								<div class="col-sm-11 form-inner">
									<select name="riskLevel" id="riskLevel" class='form-control select2_width'>
										<c:forEach var="item" items="${custrisklevelArray}">
											<option value="${item.PMCO}" ${item.PMCO == dto.riskLevel ? "selected" : "" }>${item.PMCO}&nbsp;&nbsp;${ item.PMNM }</option>
										</c:forEach>
									</select>
								</div>
							</td>
...
<script type="text/javascript" src="<%=context%>web/js/bakCustomer/bakCustomerUpdate.js?v="<%=dateStr%>></script>
