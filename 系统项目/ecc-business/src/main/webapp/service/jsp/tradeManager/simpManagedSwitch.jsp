...
<body class="sub-page">
	<div class="modal-content">
		<div>
	        <h4 class="modal-title">单步转托管</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="table-responsive">
	    	<form id="rollOutQuery" action="" name="rollOutQuery"  method="post" class="form-horizontal">
	           	...
	           	<form id="rollOut" action="" name="rollOut"  method="post" class="form-horizontal">
	            <table class="table table-bordered">
	            	<colgroup>
	                    <col width="20%">
	                    <col width="30%">
	                ...
	                <tbody style="border-top: 0;">
	                	<tr style="display: none;">
	                		<td>
	                			<input type="hidden" name="permissionId" value="8026" />
								...
								<input type="hidden" name="managedSwitchType" class="managedSwitchType" value="1"/>
	                	...
	                	<tr>
	                		<td><font color="red">*</font>转出份额：</td>
	                		<td class="white-bg form-inner" colspan="3">
	                			<input type="text" placeholder="转出份额" class="form-control" id="subQuty" name="subQuty" onKeyUp="onMoneyChange();" style="float: left;"/>
...
<script type="text/javascript" src="<%=context%>web/js/tradeManager/simpManagedSwitch.js"></script>
