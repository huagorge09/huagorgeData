...
<body class="sub-page">
	<div class="modal-content">
		<div>
	        <h4 class="modal-title">基金申购</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="table-responsive">
	    	<form id="purchaseQuery" action="" name="purchaseQuery"  method="post" class="form-horizontal">
	           	...
	           	<form id="purchase" action="/capitalService/server/addOrUpdateFundInfo.xhtml" name="purchase"  method="post" class="form-horizontal">
	            <table class="table table-bordered">
	            	<input type="hidden" name="permissionId" value="8022" />
	                ...
	                <tbody style="border-top: 0;">
	                	...
	                	<tr>
	                		<td><font color="red">*</font>申购金额：</td>
	                		<td class="white-bg form-inner" colspan="3">
	                			<input type="text" placeholder="申购金额" class="form-control" id="subAmt" name="subAmt" onKeyUp="onMoneyChange();queryDiscount();" style="float: left;"/>
...
<script type="text/javascript" src="<%=context%>web/js/tradeManager/purchase.js"></script>
