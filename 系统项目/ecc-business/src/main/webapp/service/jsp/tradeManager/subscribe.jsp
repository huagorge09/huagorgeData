...
<body class="sub-page">
	<div class="modal-content">
		<div>
	        <h4 class="modal-title">基金认购</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="table-responsive">
	    	<form id="subscribeQuery" action="" name="subscribeQuery"  method="post" class="form-horizontal">
	           	...
	           	<form id="subscribe" action="/capitalService/server/addOrUpdateFundInfo.xhtml" name="subscribe"  method="post" class="form-horizontal">
	           	<div style="display: none">
					<input type="hidden" name="permissionId" value="8021" />
					...
					<input type="hidden" name="specriskLevel" class="specriskLevel">
	            ...
	            <table class="table table-bordered">
	                ...
	                <tbody style="border-top: 0;">
	                	<tr>
	                		...
	                		<td class="white-bg form-inner">
	                			<select name="fundid" id="fundid" class="user-select2 select2" onchange="queryFundInfoData(this.value);queryDiscount();"></select>
	                		</td>
	                		<td>经办人：</td>
	                		<td class="white-bg form-inner">
	                	...
	                	<tr>
	                		<td><font color="red">*</font>认购金额：</td>
	                		<td class="white-bg form-inner" colspan="3">
	                			<input type="text" placeholder="认购金额" class="form-control" id="subAmt" name="subAmt" onKeyUp="onMoneyChange();queryDiscount();" style="float: left;"/>
	                	...
	                	<tr id='voicerecordTd' class="invprStyle" style="display: none;">
	                		<td>录音文件编号：</td>
	                		<td class="white-bg form-inner" colspan="3">
	                			<input type="text" placeholder="录音文件编号" class="form-control" id="voicerecord" name="voicerecord"/>
	                		</td>
	                	</tr>
	                	<tr>
	                		<td>折扣率：</td>
	                	...
	                	<tr>
	                		<td>合同签署：</td>
	                		<td class="white-bg form-inner">
	                			<select name="contractsign" id="contractsign" class="select2" onchange="showdiv();"></select>
	                		</td>
	                		<td><div class="isoriginal" style="display: none">合同是否原件：</div></td>
	                		<td class="white-bg form-inner">
	                			<div class="isoriginal" style="display: none;">
		                			<select name="isoriginal" id="isoriginal" class="select2">
	                	...
	                	<tr>
	                		...
	                		<td>二次风险揭示签署：</td>
	                		<td class="white-bg form-inner">
	                			<select name="riskSign" id="riskSign" class="select2">
	                				<option value="0">无需</option>
	                	...
	                	<tr>
	                		<td>投资者类型：</td>
	                		<td class="white-bg form-inner">
	                			<span class="invprtpString"></span>
	                		</td>
	                		<td class="invprStyle" colspan="2" style="display: none;">特别告知义务需留痕、二次风险揭示书面文件须保存</td>
	                	</tr>
	                	<tr>
	                		<td>证件类型：</td>
	                		<td class="white-bg form-inner">
...
<script type="text/javascript" src="<%=context%>web/js/tradeManager/subscribe.js"></script>
