...
<body class="sub-page">
	<div class="modal-content">
		<div>
	        <h4 class="modal-title">内部转托管</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="table-responsive">
	    	<form id="switchSelfQuery" action="" name="switchSelfQuery"  method="post" class="form-horizontal">
	           	...
	           	<form id="switchSelf" action="" name="switchSelf"  method="post" class="form-horizontal">
	            <table class="table table-bordered">
	            	<colgroup>
	                    <col width="20%">
	                    <col width="30%">
	                ...
	                <tbody style="border-top: 0;">
	                	<tr style="display: none;">
	                		<td>
	                			<input type="hidden" name="permissionId" value="8029" />
								...
								<input type="hidden" name="managedSwitchType" class="managedSwitchType" value="4"/>
	                	...
	                	<tr>
	                		...
	                		<td><font color="red">*</font>对方交易账号：</td>
	                		<td class="white-bg form-inner">
	                			<input type="text" placeholder="对方交易账号" class="form-control changeText" id="oTradeacco" name="oTradeacco">
	                		</td>
	                	</tr>
	                	<tr>
	                		<td><font color="red">*</font>转入份额：</td>
	                		<td class="white-bg form-inner" colspan="3">
	                			<input type="text" placeholder="转入份额" class="form-control" id="subQuty" name="subQuty" onKeyUp="onMoneyChange();" style="float: left;"/>
...
<script type="text/javascript" src="<%=context%>web/js/tradeManager/managedSwitchSelf.js"></script>
