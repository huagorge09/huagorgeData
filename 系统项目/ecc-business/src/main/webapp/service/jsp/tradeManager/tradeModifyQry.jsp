...
<div class="clearfix form-multi-col-panel">
	<div class="permissionBtn" style="display: none;" id="tradeUpdateBtn">
		<a href="javascript:void(0);" class="btn btn-link btn-jqgrid" title="进行修改" disabled ><i class="fa fa-pencil-square-o"></i></a>
	</div>
...
<script type="text/javascript" src="<%=context%>web/js/tradeManager/tradeModifyQry.js"></script>
