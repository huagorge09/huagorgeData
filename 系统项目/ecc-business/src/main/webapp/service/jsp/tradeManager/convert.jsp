...
<body class="sub-page">
	<div class="modal-content">
		<div>
	        <h4 class="modal-title">基金转换</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="table-responsive">
	    	<form id="convertQuery" action="" name="convertQuery"  method="post" class="form-horizontal">
	           	...
	           	<form id="convert" action="/capitalService/server/addOrUpdateFundInfo.xhtml" name="convert"  method="post" class="form-horizontal">
	            <table class="table table-bordered">
	            	<input type="hidden" name="permissionId" value="8024" />
					...
					<input type="hidden" name="largeflag" value="0"/>
	                ...
	                <tbody style="border-top: 0;">
	                	<tr>
	                		...
	                		<td><font color="red">*</font>对方基金名称：</td>
	                		<td class="white-bg form-inner">
	                			<select name="ofundid" id="ofundid" class="select2" ></select>
	                		</td>
	                	</tr>
	                	<tr>
	                		<td><font color="red">*</font>转换份额：</td>
	                		<td class="white-bg form-inner" colspan="3">
	                			<input type="text" placeholder="转换份额" class="form-control" id="subAmt" name="subAmt" onKeyUp="onMoneyChange();queryDiscount();" onchange="onMoneyChange();queryDiscount();" onfocus="onMoneyChange();queryDiscount();" onblur="onMoneyChange();queryDiscount();" style="float: left;"/>
						    	<span style="line-height: 33px;">
						    		<input type="checkbox" name="allAmt" id="allAmt" style="float: left;margin: 10px 5px 0 5px;" onclick="convertAll();">
						    		<span style="float: left;">&nbsp;全额转换&nbsp;&nbsp;</span>
						    	</span>
...
<script type="text/javascript" src="<%=context%>web/js/tradeManager/convert.js"></script>
