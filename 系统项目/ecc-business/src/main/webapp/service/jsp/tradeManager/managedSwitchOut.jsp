...
<body class="sub-page">
	<div class="modal-content">
		<div>
	        <h4 class="modal-title">转托管转出</h4>
	    </div>
	    <div class="modal-body">
	    	<div class="table-responsive">
	    	<form id="switchOutQuery" action="" name="switchOutQuery"  method="post" class="form-horizontal">
	           	...
	           	<form id="switchOut" action="" name="switchOut"  method="post" class="form-horizontal">
	            <table class="table table-bordered">
	            	<colgroup>
	                    <col width="20%">
	                    <col width="30%">
	                ...
	                <tbody style="border-top: 0;">
	                	<tr style="display: none;">
	                		<td>
	                			<input type="hidden" name="permissionId" value="8027" />
								...
								<input type="hidden" name="managedSwitchType" class="managedSwitchType" value="2"/>
	                	...
	                	<tr>
	                		...
	                		<td class="white-bg form-inner">
	                			<select name="seatno" id="seatno" class="select2" onchange="changeStyle(this);"></select>
	                		</td>
	                	</tr>
	                	<tr>
...
<script type="text/javascript" src="<%=context%>web/js/tradeManager/managedSwitchOut.js"></script>
