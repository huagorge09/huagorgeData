			...
			<table id="showPersonalTable" class="table table-bordered" style="display: none;">
				...
				<tbody>
					...
					<tr>
						...
						<td class="white-bg">
							<span class="col-sm-12">
								<span id="openBank" name="openBank"></span>
							</span>
						</td>
						<td>银行名称：</td>
						<td class="white-bg">
							<span class="col-sm-12">
								<span id="openName" name="openName"></span>
							</span>
						</td>
					</tr>
					<tr>
						...
						<td class="white-bg">
							<span class="col-sm-12">
								<span id="accoName" name="accoName"></span>
							</span>
						</td>
						<td>银行帐户：</td>
						<td class="white-bg">
							<span class="col-sm-12">
								<span id="bankAcco" name="bankAcco"></span>
							</span>
						</td>
					</tr>
				</tbody>
...
<script type="text/javascript" src="<%=context%>web/js/accountManger/tradeAccountMgr/deleteTradeAccount.js?v="<%=dateStr%>></script>
</body>	
</html>