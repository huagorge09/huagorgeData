...
<div class="clearfix form-multi-col-panel">
    <div class="form-search-group">
        ...
        <a class="btn btn-primary" id="openAddFundPageBtn" href="javascript:openAddFundPage();"><i class="fa fa-plus"></i>&nbsp;增加</a>
    </div>
...
<div class="jqGrid_wrapper fullscreen-wrapper">
    <table id="fundInfoList"></table>
    <div id="fundInfoPage"></div>
</div>
</body>
<script type="text/javascript" src="<%=context%>web/js/common/widget.js"></script>
<script type="text/javascript" src="<%=context%>web/js/fund/fundManager.js?201805340"></script>
