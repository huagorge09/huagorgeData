...
<body class="fixed-nav gray-bg">
	...
	<div class="clearfix form-multi-col-panel">
		<div class="form-search-group">
			<a class="btn btn-primary"  href="javascript:roleFunc.updatePrivilegeAuthRel();">&nbsp更新查询权限</a>
	        <a class="btn btn-primary" id="contactsAdd" name="contactsAdd" href="javascript:roleFunc.roleAddView('add');"><i class="fa fa-plus"></i>&nbsp新增</a>    
	    </div>
...
<script type="text/javascript" src="<%=context%>web/js/role/role.js"></script>
<script type="text/javascript">
		var basePath = "<%=context%>";
		var primaryPath = "<%=context%>service/role";
		var privilegePath = "<%=context%>service/privilege";
		setPath(primaryPath,basePath,privilegePath);
</script>
