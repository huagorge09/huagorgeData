...
<script type="text/javascript" src="<%=context%>web/js/businessMgr/param/businParaManageIndex.js"></script>
<script type="text/javascript" src="<%=context%>web/js/fund/common.js"></script>
