...
(function(factory){
	...
	Datepicker.prototype = {
		...
		place: function(){
			...
			//this code added for: when text align right or center, fix picker position
			if (this.element.css("text-align") == "right") {
				left = width - calendarWidth + left;
				this.picker.removeClass("datepicker-orient-left");
				this.picker.addClass('datepicker-orient-right');
			} else if (this.element.css("text-align") == "center") {
				left = (width - calendarWidth + left) / 2;
			}
      ...
      var localDate = this._utc_to_local(this.viewDate);
		...
		navArrowsClick: function(e){
			var target = $(e.target);
			var dir = target.hasClass('prev') || target.hasClass('fa-chevron-left') ? -1 : 1;
			if (this.viewMode !== 0){
