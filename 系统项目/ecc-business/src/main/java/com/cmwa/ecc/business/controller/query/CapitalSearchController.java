...
@Controller
@RequestMapping("service/capitalSearch")
public class CapitalSearchController {
	
	private static Logger logger = Logger.getLogger(CapitalSearchController.class);	
	
	@Autowired
	private DsReportService dsReportService;

	
	@RequestMapping(value = "/capitalSrh.do",method = RequestMethod.GET)
	public String goCapitalSearchView(ModelMap map) {				
		return "jsp/report/capitalinfo";
	}
	/*获取报表链接 */
