...
public class JsonUtil {
     ...
     * @return
     */
    public static String javaList2JsonList(List<Object> list) {
	...
	public static <T> Collection<T> jsonArray2JavaList(String jsonArray, Class<T> clas) {
        JSONArray jarr = JSONArray.fromObject(jsonArray);
        return JSONArray.toCollection(jarr, clas);
    }
