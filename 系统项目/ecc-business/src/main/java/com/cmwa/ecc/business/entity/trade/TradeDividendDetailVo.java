/**
* @Title: TradeDividendDetailVo.java  
* @author ex-wuh2  
* @date 2018年6月13日  
* @version V1.0  
 */
 ...
 *	当天分红Vo 
 */
@Alias("tradeDividendDetailVo")
public class TradeDividendDetailVo implements Serializable {
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof TradeDividendDetailVo))
            return false;
        TradeDividendDetailVo that = (TradeDividendDetailVo) obj;
