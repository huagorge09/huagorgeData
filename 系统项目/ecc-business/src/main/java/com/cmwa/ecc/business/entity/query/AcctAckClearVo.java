 ...
 *	二级清算账户
 */
@Alias("acctAckClearVo")
public class AcctAckClearVo implements Serializable {
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof AcctAckClearVo))
            return false;
        AcctAckClearVo that = (AcctAckClearVo) obj;
