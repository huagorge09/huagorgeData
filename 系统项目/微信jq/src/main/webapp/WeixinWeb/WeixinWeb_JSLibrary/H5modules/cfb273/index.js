...
$(function(){
    ...
    localStorage.setItem("type","cfb273");
});
/* 验证输入框的有效性  */
	...
	$.ajax({
			...
			success : function(data) {
				if(data.success){
					...
					$("#saveBtn").addClass("disabled").attr("onclick","");
				    operatingRecord(pageSource,"event_cfb273_subscribeId",pageId,"","","","")
				}else{
 ...
 */
function elemBind(){
	var params="fundId=181030&period=11"
	$(".once").click(function(){
		operatingRecord(pageSource,"event_cfb273_buyId",pageId,"","","","")
 ...
 */
function bussiness(){	
     operatingRecord(pageSource,"event_cfb273_interestId",pageId,"","","","")
 ...
 */
function myAdviser(){
	location.href="/WeixinService/H5modules/H5Content/cfb273/bussinessCard.html?pageSource="+pageSource+"&eventId=event_cfb273_adviserId"
}
function seeProduct(){
	location.href="/WeixinService/H5modules/H5Content/cfb273/index.html?pageSource="+pageSource+"&eventId=event_cfb273_h5Id"
}
