...
$(document).ready(function (e) {
    ...
    /*if(!flag){
        ...
        setTimeout(function(){
            redirectUrl("/WeixinService/business/bank/bankAuthNew.shtml");
        }, 2000);
    }*/
    ...
    $("#queryRiskHistory").click(function () {
        window.location.href = "/WeixinService/business/user/userRiskHistoryNew.shtml";
    });
    ...
    if (VIEW_TYPE_PRODUCT == viewType) {
        ...
        $("#section_01 a[class=riskevaluation-btn]").attr("href", "/WeixinService/business/query/fundListNew.shtml");
        toRisk();
    }
...
function restRiskLevel() {
    ...
    redirectUrl('/WeixinService/business/user/riskLevelNew.shtml?&pageId=' + pageId + '&pageSource=' + pageSource);
}
        ...
        success: function (data) {
            if (data.success) {
                ...
                if (returnCode != null && returnCode == "9001") {
                    ...
                    $(".header .top-a h2").html("风险评测");
                    document.title = "风险评测";
                    var riskLevelDto = data.resp.riskLevelDto;
                    ...
                    $(".testDate").html(data.resp.riskEvalDate);
                    $(".valiDate").html(data.resp.evalValiDate);
                    $(".riskLevlNm").html(tempName);
                    var type = localStorage.getItem("type");
                    var target = localStorage.getItem("target");
                    if (type == "cfb273") {
                        addCookie("eventId", "event_cfb273_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfb273_riskRatingId", "wx_cfb273_riskRatingPageId", "", "", "", "")//财富宝
                    } else if (type == "7DaysPro") {
                        addCookie("eventId", "event_7DaysPro_riskRatingId");  //七天产品
                        operatingRecord(getCookie("pageSource"), "event_7DaysPro_riskRatingId", "wx_7DaysPro_riskRatingPageId", "", "", "", "")//七天产品
                    } else if (type == "currentPro") {
                        addCookie("eventId", "event_currentPro_riskRatingId");  //活期产品
                        operatingRecord(getCookie("pageSource"), "event_currentPro_riskRatingId", "wx_currentPro_riskRatingPageId", "", "", "", "")//七天产品
                    }else if (type == "cfb10") {
                        addCookie("eventId", "event_cfb10_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfb10_riskRatingId", "wx_cfb10_riskRatingPageId", "", "", "", "")//财富宝
                    }else if (type == "cfb126") {
                        addCookie("eventId", "event_cfb126_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfb126_riskRatingId", "wx_cfb126_riskRatingPageId", "", "", "", "")//财富宝
                    }else if (type == "annualBonus") {
                        addCookie("eventId", "event_annualBonus_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_annualBonus_riskRatingId", "wx_annualBonus_riskRatingPageId", "", "", "", "")//财富宝
                    }else if (type == "cfb28") {
                        addCookie("eventId", "event_cfb28_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfb28_riskRatingId", "wx_cfb28_riskRatingPageId", "", "", "", "")//财富宝
                    }else if (type == "cfbAll") {
                        addCookie("eventId", "event_cfbAll_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfbAll_riskRatingId", "wx_cfbAll_riskRatingPageId", "", "", "", "")//财富宝
                    }else if (type == "cfb203") {
                        addCookie("eventId", "event_cfb203_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfb203_riskRatingId", "wx_cfb203_riskRatingPageId", "", "", "", "")//财富宝
                    }else if (type == "cfbQun") {
                        addCookie("eventId", "event_cfbQun_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfbQun_riskRatingId", "wx_cfbQun_riskRatingPageId", "", "", "", "")//财富宝
                    }else if (type == "cfb207") {
                        addCookie("eventId", "event_cfb207_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfb207_riskRatingId", "wx_cfb207_riskRatingPageId", "", "", "", "")//财富宝
                    }else if (type == "cfb209") {
                        addCookie("eventId", "event_cfb209_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfb209_riskRatingId", "wx_cfb209_riskRatingPageId", "", "", "", "")//财富宝
                    }else if (type == "fatherDay") {
                        addCookie("eventId", "event_fatherDay_riskRatingId");  //父亲节
                        operatingRecord(getCookie("pageSource"), "event_fatherDay_riskRatingId", "wx_fatherDay_riskRatingPageId", "", "", "", "")//父亲节
                    }else if (type == "chenli") {
                        addCookie("eventId", "event_chenli_riskRatingId");  //chenli
                        operatingRecord(getCookie("pageSource"), "event_chenli_riskRatingId", "wx_chenli_riskRatingPageId", "", "", "", "")//chenli
                    }else if (type == "chenrui") {
                        addCookie("eventId", "event_chenrui_riskRatingId");  //chenli
                        operatingRecord(getCookie("pageSource"), "event_chenrui_riskRatingId", "wx_chenrui_riskRatingPageId", "", "", "", "")//chenli
                    }else if (type == "cfbAll2") {
                        addCookie("eventId", "event_cfbAll2_riskRatingId");  //财富宝
                        operatingRecord(getCookie("pageSource"), "event_cfbAll2_riskRatingId", "wx_cfbAll2_riskRatingPageId", "", "", "", "")//财富宝
                    }
                    //addCookie("eventId","event_wxYh91No10_riskRatingId");  //远航5号
                    //operatingRecord(getCookie("pageSource"),"event_wxYh91No10_riskRatingId","wx_yh91No10_riskRatingPageId","","","","")//远航5号
                    //addCookie("eventId","event_hlNo5_riskRatingId");  //远航5号
                    //operatingRecord(getCookie("pageSource"),"event_hlNo5_riskRatingId","wx_hlNo5_riskRatingPageId","","","","")//和力5号
                    //addCookie("eventId","event_heli6_riskRatingId");  //和利6
                    //operatingRecord(getCookie("pageSource"),"event_heli6_riskRatingId","wx_heli6_riskRatingPageId","","","","")//和利6

                    if (target == "proList") {
                        t_delay = setInterval(function () {
                            location.href = "/WeixinService/indexNew.shtml"
                        }, 3000);
                    } else {
                        t_delay = setInterval(function () {
                            location.href = "/WeixinService/H5modules/H5Content/" + target + ".html"
                        }, 3000);
                    }
...
function queryUserInfo() {
    var url = apiHost + "/api/queryUserinfo";
    $.ajax({
        async: false,
        url: url,
        ...
        success: function (data) {
            if (data.returnCode == "0000") {
                ...
                if (data.userType == null || data.userType != "30") {
                    errorRemark("请您完成实名鉴权");
                    window.setTimeout("redirectUrl('/WeixinService/business/bank/bankAuthNew.shtml?pageSource=wx_riskLevelId')", 1000);
                }
...
function applyInvestor() {
    ...
    $.ajax({
        async: !1,
        url: apiHost + "/api/appConversionUserInvtp",
        data: {
            apptp: "0",
            "cmfUserId": localStorage.getItem("cmfUserId")
        },
        ...
        success: function (n) {
            if (n != null && n.resultCode == "0000") {
                window.location.href = "/WeixinService/business/user/applySpecialtyInvSuccessNew.shtml";
            } else {
 ...
 */
function cacelApply() {
    window.location.href = "/WeixinService/business/user/userInfoNew.shtml";
}
...
//		$("#section_17 ul li:eq(0)").click();
        ...
        $("#section_17 ul li:eq(0)").find("div p").html("年龄不满16岁，不具有完全民事行为能力。<a href='/WeixinService/business/user/userInfoNew.shtml'>请根据实际情况填写出生日期。</a>");
