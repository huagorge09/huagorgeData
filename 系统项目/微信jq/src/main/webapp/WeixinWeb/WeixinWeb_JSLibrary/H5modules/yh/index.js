    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.success) {
                ...
                $("#saveBtn").addClass("disabled").attr("onclick", "");
                //operatingRecord(pageSource,"event_wxCfb91No10_consultId",pageId,"","","","") //财富宝
                operatingRecord(pageSource, "event_wxYh91No10_consultId", pageId, "", "", "", "") //远航5号
            } else {
 ...
 */
function elemBind() {
    var params = "fundId=17D971&period=1"
    $(".once").click(function () {
        //operatingRecord(pageSource, "event_wxCfb91No10_proDetailBtnH5Id", "", "", "", "", "") //财富宝
        operatingRecord(pageSource, "event_wxYh91No10_proDetailBtnH5Id", "", "", "", "", "")  //远航5号
        redirectUrl("/WeixinService/business/query/fundInfo.shtml?" + params);
    });

    $('ul.item li').click(function () {
        //operatingRecord(pageSource, "event_wxCfb91No10_proDetailAreaH5Id", "", "", "", "", "")  //财富宝
        operatingRecord(pageSource, "event_wxYh91No10_proDetailAreaH5Id", "", "", "", "", "")  //远航5号
        redirectUrl("/WeixinService/business/query/fundInfo.shtml?" + params);
    });
    //鼠标键盘弹起
 ...
 */
function bussiness() {
    //operatingRecord(pageSource, "event_wxCfb91No10_interestedId", pageId, "", "", "", "") //财富宝
    operatingRecord(pageSource, "event_wxYh91No10_interestedId", pageId, "", "", "", "")  //远航5号
 ...
 */
function myAdviser() {
    location.href = "/WeixinService/H5modules/H5Content/yh/bussinessCard.html?pageSource=" + pageSource + "&eventId=event_wxYh91No10_myAdviserId"
}
function seeProduct() {
    location.href = "/WeixinService/H5modules/H5Content/yh/index.html?pageSource=" + pageSource + "&eventId=event_wxYh91No10_h5Id"
}
