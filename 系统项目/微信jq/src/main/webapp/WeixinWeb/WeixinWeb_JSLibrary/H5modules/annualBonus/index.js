...
function elemBind(){
    try{
		...
		$(".makeBuy1").click(function(){
            ...
            redirectUrl("/WeixinService/business/query/fundInfo.shtml?fundId=17D987&period=1")
		});
		$(".makeBuy2").click(function(){
			operatingRecord(pageSource,"event_annualchangli_buyId","","","","","")
			redirectUrl("/WeixinService/business/query/fundInfo.shtml?fundId=17D969&period=1")
		});
