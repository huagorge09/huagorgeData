    ...
    var a, t = function(e, s) {
        ...
        T.getActiveBreakpoint = function() {
            if (!T.params.breakpoints)
                return !1;
            var e = !1;
            for (var t in T.params.breakpoints)
                T.params.breakpoints.hasOwnProperty(t) && t >= a(window).width() && !e && (e = t);
            return e || "max"
        }
        ,
        ...
        0 !== T.container.length)) {
            ...
            T.update = function(e) {
                ...
                e) {
                    ...
                    T.params.freeMode ? a() : (t = ("auto" === T.params.slidesPerView || T.params.slidesPerView > 1) && T.isEnd && !T.params.centeredSlides ? T.slideTo(T.slides.length - 1, 0, !1, !0) : T.slideTo(T.activeIndex, 0, !1, !0),
                    t || a())
                }
            }
            ,
            ...
            T.onTouchMove = function(e) {
                ...
                !(A && "mousemove" === e.type || e.preventedByNestedSwiper)) {
                    if (T.params.onlyExternal)
                        ...
                        E = Date.now()));
                    if (A && document.activeElement && e.target === document.activeElement && a(e.target).is(B))
                        return C = !0,
                        void (T.allowClick = !1);
            ...
            T.slideTo = function(e, a, t, r) {
                ...
                T.updateProgress(s);
                for (var n = 0; n < T.slidesGrid.length; n++)
                    -Math.floor(100 * s) >= Math.floor(100 * T.slidesGrid[n]) && (e = n);
                if (!T.params.allowSwipeToNext && s < T.translate && s < T.minTranslate())
                    return !1;
                if (!T.params.allowSwipeToPrev && s > T.translate && s > T.maxTranslate() && (T.activeIndex || 0) !== e)
                    return !1;
                if ("undefined" == typeof a && (a = T.params.speed),
                T.previousIndex = T.activeIndex || 0,
                T.activeIndex = e,
                s === T.translate)
                    return T.updateClasses(),
                    !1;
                T.updateClasses(),
                T.onTransitionStart(t);
                i() ? s : 0,
                i() ? 0 : s;
                return 0 === a ? (T.setWrapperTransition(0),
                T.setWrapperTranslate(s),
                T.onTransitionEnd(t)) : (T.setWrapperTransition(a),
                T.setWrapperTranslate(s),
                T.animating || (T.animating = !0,
                T.wrapper.transitionEnd(function() {
