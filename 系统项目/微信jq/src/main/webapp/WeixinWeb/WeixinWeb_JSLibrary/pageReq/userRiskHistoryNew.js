﻿function queryRiskHistory() {
	$("#titleBack").click(function(){
		$('#titleBack').attr("href","javascript:redirectUrl('/WeixinService/business/user/riskLevelNew.shtml')");
	});
...
function backRiskPage(){
	window.location.href="/WeixinService/business/user/riskLevelNew.shtml";
}