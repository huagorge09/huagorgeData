	...
	$.ajax({
        ...
        success : function (data){
			...
			if(data.asstesInCome.userType != null && data.asstesInCome.userType == "10"){
				$("div.center-info a.href-point.bank-manage").attr("href","javascript:redirectUrl('/WeixinService/business/bank/bankAuth.shtml?pageSource=wx_activeId')");
			}
...
function toMyMessage(){
	...
	if(!!result && !result.flag){
		redirectUrl('/WeixinService/business/query/msgList.shtml');
	}
}
