...
function goToBuyOrder() {
	...
	if (fundId != "" && fundId != null) {
		window.location.href = "/WeixinService/business/pay/buyMoneyNew.shtml?fundId=" + fundId+"&period="+period;
	} 
	if(serialno != "" && serialno != null){
		if(type == 1){
			window.location.href = "/WeixinService/business/query/orderDetailNew.shtml?serialno=" + serialno;
		}else{
			window.location.href = "/WeixinService/business/pay/confirmBuyNew.shtml?serialno=" + serialno;
		}
	}
}