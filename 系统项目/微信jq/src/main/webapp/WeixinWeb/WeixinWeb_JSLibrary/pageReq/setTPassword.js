		...
		$.ajax({
			...
			success : function(data){
				...
				if(returnCode == 'USR-1I00'){
					errorRemark("安全码设置成功");
					window.setTimeout('redirectUrl("/WeixinService/business/user/userInfo.shtml")',2000);
					...
					window.setTimeout('redirectUrl("/WeixinService/business/bank/bankAuth.shtml")',3000);
				}else{
					errorRemark("网络繁忙，请稍后再试");
				}
			}
