        ...
        success : function (data){
        	...
        	if(list != null && list.length > 0){
        		$.each(list,function(i, item){
        			if(item.hasDetail=='Y'){
        				htmls1 += "<a href='/WeixinService/business/query/otherOrderDetailNew.shtml?serialno="+item.serialno+"&fundId="+item.fundid+"&channleNo="+item.channleNo+"'><div class='box-order'>";
        			}else{
        	...
        	if(gList != null && gList.length > 0){
        		$.each(gList,function(i, item){
        			...
        			if(item.hasDetail=='Y'){
        				htmls2 += "<a href='/WeixinService/business/query/otherOrderDetailNew.shtml?serialno="+item.serialno+"&fundId="+item.fundid+"&channleNo="+item.channleNo+"'><div class='box-order'>";
        			}else{
        	...
        	if(zList != null && zList.length > 0){
        		$.each(zList,function(i, item){
        			...
        			profit = parseFloat(item.profit).toFixed(2);
        			if(item.hasDetail=='Y'){
        				htmls3 += "<a href='/WeixinService/business/query/otherOrderDetailNew.shtml?serialno="+item.serialno+"&fundId="+item.fundid+"&channleNo="+item.channleNo+"'><div class='box-order'>";
        			}else{
