		...
		$.ajax({
			...
			success : function(data){
				if(data.returnCode != null && data.returnCode == "0000"){
					errorRemark("修改成功");  
					window.setTimeout("redirectUrl('/WeixinService/business/query/orderDetailNew.shtml?serialno="+serialno+"');",1000);
...
function addBank(){
	...
	window.location.href="/WeixinService/business/bank/addBankNew.shtml?type=1&serialno="+param;
}