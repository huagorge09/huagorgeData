...
var link=host+"/WeixinService/weixinLogin/register.shtml";
...
function eventBind(){
	...
	$('#useButton').click(function(){
		...
		if(isRealName=='true'){
			window.location.href='/WeixinService/business/mgm/useMyIntegral.shtml';
	...
	$('#toUserRecordBtn').click(function(){
		var isRealName=$('#isRealName').val();
		if(isRealName=='true'){
			window.location.href='/WeixinService/business/mgm/integralRecord.shtml';
		}else if(isRealName=='false'){
			$('#realNamePop').show()
			$('.backLayer').show()
		}
	...
	$('#myRecommendBtn').click(function(){
		var isRealName=$('#isRealName').val();
		if(isRealName=='true'){
			window.location.href='/WeixinService/business/mgm/myRecommender.shtml';
		}else if(isRealName=='false'){
			$('#realNamePop').show()
			$('.backLayer').show()
		}
...
function queryIntegralDeatail(){
	link=host+"/WeixinService/weixinLogin/register.shtml?invitation="+invitationCode;   //转发链接
...
function shareProduct(typeId,period){
   ...
   location.href="/WeixinService/business/query/fundInfo.shtml?fundId="+typeId+"&period="+period+"&isShare=Invitation"
}
