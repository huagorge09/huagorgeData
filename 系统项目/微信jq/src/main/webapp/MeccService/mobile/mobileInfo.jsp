...
<%@ page import = "com.cmwa.ec.weixin.constants.WXConstants"%>
<%@ page import = "com.cmwa.ec.user.facade.dto.UserBaseInfoDto"%>
<%@ page import = "com.cmwa.ec.weixin.util.MD5"%>
<%@ page import = "com.cmwa.ec.base.dto.Context"%>
<%@ page import = "com.cmwa.ec.weixin.util.ContextUtils"%>
<%@ page import = "com.cmwa.ec.weixin.client.UserServiceClient"%>
...
<%@ page import = "org.apache.log4j.Logger"%>
 ...
 <%
	...
	try {
		...
		//记录日志
		Context context=ContextUtils.setContext(WXConstants.USER_SERVICE_001, channel,
				"", System.currentTimeMillis(), System.currentTimeMillis(), seqId, "");
		 //发送请求
		UserServiceMessage userServiceMsg = client.queryMeccLogin(context, LonginAccunt,LoginCode,WXConstants.LOGIN_CHANEL_90 , WXConstants.LOGIN_NMARK_03,LoginUserId);
		//返回的信息
		String returnCode="";
		String returnMsg="";
			...
			%>
				window.location.href="/WeixinService/index.shtml";
				</script>
			<%
		 } catch (Exception e) {
