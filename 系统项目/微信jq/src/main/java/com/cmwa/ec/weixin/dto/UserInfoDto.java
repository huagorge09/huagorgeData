...
public class UserInfoDto {
	...
	public String toString(){
    	...
    	sb.append("[");
    	sb.append("openId:").append(this.getOpenid()).append(";");
    	sb.append("city:").append(this.getCity()).append(";");
    	sb.append("country:").append(this.getCountry()).append(";");
    	sb.append("headImgurl:").append(this.getHeadimgurl()).append(";");
    	...
    	sb.append("subscribeTime:").append(this.subscribe_time).append(";");
    	sb.append("]");
    	return sb.toString();
    } 
