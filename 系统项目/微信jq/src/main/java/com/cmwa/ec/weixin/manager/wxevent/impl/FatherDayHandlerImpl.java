...
public class FatherDayHandlerImpl extends DefaultEventHandlerImpl {
	private Logger logger = Logger.getLogger(FatherDayHandlerImpl.class);
	...
	public String wxSubscribe(EventReqMsgDto eventReqDto) throws Exception {
		...
		key = WXConstants.PMST_MESSAGE + "#" + WXConstants.FATHER_DAY + "#"+WXConstants.FATHER_MOVIE_TICKET;
		serviceMessage = getFatherServiceWelcomeMsg(key,openid, weixinUserName);
	 ...
	 * @return
	 */
	private String getFatherServiceWelcomeMsg(String key ,String openId,String weixinUserName){
