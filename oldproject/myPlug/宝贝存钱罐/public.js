...
var publicPage=function () {
    ...
    function audioLoad() {
        $(".record audio").each(function () {
            $(this).get(0).ondurationchange = function () {
                console.log(this);
    ...
    function audioPlay() {
        ...
        $(".record .button").on("click",function () {
            ...
            audio.src = "http://pic.ibaotu.com/00/22/50/22t888piCF8X.mp3";
            console.log(audio);
            playerButton = $(this);
            ...
            var flag = playerButton.parents(".record").hasClass("headAudioPlayer");
            if(flag){
